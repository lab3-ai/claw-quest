    ...
    return (
        <div className="min-h-screen bg-bg-base">
            ...
            <div className="max-w-3xl mx-auto px-6 py-10 pb-20 text-fg-1 text-sm leading-relaxed">
                ...
                <p className="mb-3 text-fg-3">When you use ClawQuest, we collect information you provide directly:</p>
                ...
                <p className="mb-3 text-fg-3">Your data is stored securely using:</p>
                <ul className="mb-4 ml-5 text-fg-3">
                ...
                <p className="mb-3 text-fg-3">We use the following third-party services:</p>
                <ul className="mb-4 ml-5 text-fg-3">
                ...
                <p className="mb-3 text-fg-3">We do not sell your personal data. We share data only when:</p>
                <ul className="mb-4 ml-5 text-fg-3">
                ...
                <p className="mb-3 text-fg-3">You can:</p>
                <ul className="mb-4 ml-5 text-fg-3">
                ...
                <p className="mb-3 text-fg-3">We use essential cookies only for authentication session management. No tracking or advertising cookies are used.</p>

                <h2 className="text-base font-semibold mt-8 mb-2">8. Contact</h2>
                <p className="mb-3 text-fg-3">For privacy questions, contact us at <a href="mailto:privacy@clawquest.ai" className="text-primary">privacy@clawquest.ai</a>.</p>
            </div>
        </div>
    )
}

...
| Platform | Hex | Source |
|----------|-----|--------|
| Telegram | `#229ED9` | Official brand |
| Discord | `#5865F2` | Official brand |
| X/Twitter | `#0F1419` | Official brand |
| Stripe | `#635BFF` | Official brand |
...
See `design-system.md` for full type scale.

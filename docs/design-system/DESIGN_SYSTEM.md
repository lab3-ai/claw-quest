...
| **Font** | Google Sans Code | Single monospace font, all weights |
...
Principles:
1. **Monospace-first** — Google Sans Code everywhere, code-like precision
...
**Single font:** Google Sans Code — monospace for everything.
...
|-------|-------|----------|
| `--font` | `"Google Sans Code", ui-monospace, ...` | `font-sans` |
| `--font-heading` | `"Google Sans Code", ui-monospace, ...` | `font-heading` |
| `--font-mono` | `"Google Sans Code", ui-monospace, ...` | `font-mono` |
...
|-------|------|-------|--------|---------|
| **Terminal** (default) | Google Sans Code | Flat, monospace, high-contrast | 0–8px | None (light), subtle + brand glow (dark) |
